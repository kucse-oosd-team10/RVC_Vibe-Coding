...
bool CombinedFrontObstacleSensorAdapter::initialize() { return sensor_.initialize(); }
...
bool CombinedSideObstacleSensorAdapter::initialize() { return sensor_.initialize(); }
...
void MovementMotorAdapter::stop() { motor_.move(Direction::STOP); }

void MovementMotorAdapter::moveForward() { motor_.move(Direction::FORWARD); }

void MovementMotorAdapter::moveBackward() { motor_.move(Direction::BACKWARD); }

void MovementMotorAdapter::turnLeft() { motor_.move(Direction::LEFT); }

void MovementMotorAdapter::turnRight() { motor_.move(Direction::RIGHT); }

CleaningMotorAdapter::CleaningMotorAdapter(ICleaner &cleaner) : cleaner_{cleaner} {}

void CleaningMotorAdapter::off() { cleaner_.setPower(PowerLevel::OFF); }

void CleaningMotorAdapter::normal() { cleaner_.setPower(PowerLevel::NORMAL); }

void CleaningMotorAdapter::powerUp() { cleaner_.setPower(PowerLevel::POWER_UP); }
